 ...
 *
 * The followings are the available columns in table 'secret_question':
 * @property string $id
 * @property string $question_content
 */
class SecretQuestion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SecretQuestion the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, question_content', 'safe', 'on'=>'search'),
		);
	}
